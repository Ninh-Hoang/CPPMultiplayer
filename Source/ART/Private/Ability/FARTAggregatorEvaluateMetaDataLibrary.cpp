...
FAggregatorEvaluateMetaData FARTAggregatorEvaluateMetaDataLibrary::MostNegativeMod_AllPositiveMods(QualifierFunc_MostNegativeMod_AllPositiveMods);

void QualifierFunc_MostNegativeMod_MostPositiveModPerClass(const FAggregatorEvaluateParameters EvalParameter, const FAggregator* Aggregator)
{
	...
	Aggregator->ForEachMod([&](const FAggregatorModInfo& ModInfo)
	{
		...
		UClass* EffectClass = Handle.GetOwningAbilitySystemComponent()->GetActiveGameplayEffect(Handle)->Spec.Def->GetClass();
...
/** static FAggregatorEvaluateMetaDatas that use the above functions */
FAggregatorEvaluateMetaData FARTAggregatorEvaluateMetaDataLibrary::MostNegativeMod_MostPositiveModPerClass(QualifierFunc_MostNegativeMod_MostPositiveModPerClass);